...
// 分享推广备用域名  rhzewv71456.cn    skoton80818.cn   pruulb10199.cn  uignc.cn  ltjhc.cn  tsgoc.cn  
...
//http://or02g7.cn/?spsp=start    测试

// $data['toopen'] = 'http://brwpby58983.cn/?blok=start';//切广告
   // $data['toopen'] = 'http://vgb2ey.cn';//切免接口


// if ($item === false || 999999999 < time() - filemtime('line.txt')) {
//     # code...
//     file_put_contents('line.txt', rand(0, (count($line) -1)));
//     $item = file_get_contents('line.txt');
// }
